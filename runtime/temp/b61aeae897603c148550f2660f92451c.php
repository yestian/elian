<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:62:"D:\www\tp\elian\public/../application/admin\view\file\lst.html";i:1504509244;s:65:"D:\www\tp\elian\public/../application/admin\view\public\meta.html";i:1504623373;s:64:"D:\www\tp\elian\public/../application/admin\view\agent\menu.html";i:1504509244;s:65:"D:\www\tp\elian\public/../application/admin\view\member\menu.html";i:1504509244;}*/ ?>
<!doctype html>
<html lang="en">
...
<div class="page-summary">
  ...
  <div class="layui-progress-bar layui-bg-orange" lay-percent="<?php echo $menu['agent_mem_per']; ?>%"></div>
                ...
                <?php elseif($ctr == 'Member'): ?><div class="sidebar2">
    <ul>
        <li><a class="homelink"><i class="fa fa-home"></i><span>HOME</span></a></li>
...
<?php endif; ?>
                <div class="page-content">
                    <div class="bread">
                        <i class="icon-home"></i>
                        <a href="#" class="homelink">首页</a> > 文档列表
                    </div>
                    <div class="body">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h2 class="panel-title">文档列表 <?php if($ctr == 'Agent'): ?><a href="<?php echo url('file/upload',array('ctr'=>$ctr)); ?>" class="btn btn-info btn-xs">添加</a><?php else: ?><a href="<?php echo url('file/upload'); ?>" class="btn btn-info btn-xs">添加</a><?php endif; ?></h2>
                            </div>
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover text-center">
                                        <tr>
                                            <th width='45px'>id</th>
                                            <th><a href="<?php echo url('lst',array('fld'=>'id','way'=>'desc')); ?>">文件标题</a></th>
                                       ...
                                       <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        <tr>
                                            ...
                                            <td><a href="<?php echo url('file/download',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm">下载</a>
                                                <a href="<?php echo url('file/del',array('ctr'=>\think\Request::instance()->controller(),'id'=>$vo['id'])); ?>" class="btn btn-danger btn-sm">删除</a></td>
                                        </tr>
