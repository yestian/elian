<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"D:\www\tp\elian\public/../application/admin\view\agent\add.html";i:1504713501;s:65:"D:\www\tp\elian\public/../application/admin\view\public\meta.html";i:1504623373;s:64:"D:\www\tp\elian\public/../application/admin\view\agent\menu.html";i:1504509244;}*/ ?>
<!doctype html>
<html lang="en">
...
<div class="page-summary">
  ...
  <div class="layui-progress-bar layui-bg-orange" lay-percent="<?php echo $menu['agent_mem_per']; ?>%"></div>
                ...
                <div class="page-content">
                    <div class="bread">
                        <i class="icon-home"></i>
                        <a href="#" class="homelink">首页</a> > 添加代理商
                    </div>
                    <div class="body">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h2 class="panel-title">添加代理商</h2>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <form action="" method='post' enctype="multipart/form-data" class="addagent">
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tr>
                                                <td>代理商机构名称 <span class="text-danger">*</span></td>
                                                <td>
                                                    <input type="text" class="form-control" name="agentname" datatype="*4-30" errormsg="4-30个字符" placeholder="4-30个字符">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>代理级别 <span class="text-danger">*</span></td>
                                                <td>
                                                    <select name="level" id="" class="form-control" datatype="*">
                                            ...
                                            <tr>
                                                <td>联系人</td>
                                                <td>
                                                    <input type="text" class="form-control" name='linkman' placeholder="代理商联系人姓名">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>手机号码</td>
                                            ...
                                            <tr>
                                                <td>上级代理商id</td>
                                                <td>
                                                    <input type="text" class="form-control" name='upid' placeholder="如没有，请留空">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>用户头像</td>
