<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\www\tp\elian\public/../application/member\view\member_admin\edit.html";i:1505457358;s:66:"D:\www\tp\elian\public/../application/member\view\public\meta.html";i:1505446123;s:72:"D:\www\tp\elian\public/../application/member\view\member_admin\menu.html";i:1505459690;}*/ ?>
<!doctype html>
<html lang="en">
...
<div class="page-summary">
  ...
  <div class="layui-progress-bar layui-bg-orange" lay-percent="<?php echo $menu['agent_mem_per']; ?>%"></div>
                ...
                <div class="page-content">
                    <div class="bread">
                        <i class="icon-home"></i>
                        <a href="#" class="homelink">首页</a> > 管理员编辑
                    </div>
                    <div class="body">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h2 class="panel-title">管理员编辑 <a href="<?php echo url('add'); ?>" class="btn btn-info btn-xs">添加</a></h2>
                            </div>
                            <div class="panel-body">
                                <form class="form-horizontal" role="form" action="" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select name="group_id" class="form-control">
                                                ...
                                                <option <?php if($vo['id'] == $groupId): ?>selected<?php endif; ?> value="<?php echo $vo['id']; ?>"><?php echo $vo['title']; ?></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input class="form-control" placeholder="" name="username" value="<?php echo $admin['username']; ?>" type="text">
                                        </div>
                                        <p class="help-block col-sm-4 red">* 必填</p>
                                    </div>
                                    <div class="form-group">
