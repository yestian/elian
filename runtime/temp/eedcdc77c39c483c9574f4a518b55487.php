<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"D:\www\tp\elian\public/../application/admin\view\agent\lst.html";i:1504713501;s:65:"D:\www\tp\elian\public/../application/admin\view\public\meta.html";i:1504623373;s:64:"D:\www\tp\elian\public/../application/admin\view\agent\menu.html";i:1504509244;}*/ ?>
<!doctype html>
<html lang="en">
...
<div class="page-summary">
  ...
  <div class="layui-progress-bar layui-bg-orange" lay-percent="<?php echo $menu['agent_mem_per']; ?>%"></div>
                ...
                <div class="page-content">
                    <div class="bread">
                        <i class="icon-home"></i>
                        <a href="#" class="homelink">首页</a> > 代理商列表
                    </div>
                    <div class="body">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h2 class="panel-title">代理商列表 <a href="<?php echo url('add'); ?>" class="btn btn-info btn-xs">添加</a></h2>
                            </div>
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover text-center">
                                        <tr>
                                            <th><a href="<?php echo url('lst',array('fld'=>'id','way'=>'desc')); ?>">id <i class="fa fa-caret-down"></i></a></th>
                                            <th><a href="<?php echo url('lst',array('fld'=>'username')); ?>">账号 <i class="fa fa-caret-down"></i></a></th>
                                            <th><a href="<?php echo url('lst',array('fld'=>'agentname')); ?>">机构 <i class="fa fa-caret-down"></i></a></th>
                                            <th><a href="<?php echo url('lst',array('fld'=>'level','way'=>'desc')); ?>">级别 <i class="fa fa-caret-down"></i></a></th>
                                            <th><a href="<?php echo url('lst',array('fld'=>'allpay','way'=>'desc')); ?>">总充值 <i class="fa fa-caret-down"></i></a></th>
                                            <th><a href="<?php echo url('lst',array('fld'=>'balance','way'=>'desc')); ?>">余额 <i class="fa fa-caret-down"></i></a></th>
                                            <th><a href="<?php echo url('lst',array('fld'=>'upidsum','way'=>'desc')); ?>">子代理 <i class="fa fa-caret-down"></i></a></th>
                                            <th><a href="<?php echo url('lst',array('fld'=>'memsum','way'=>'desc')); ?>">会员 <i class="fa fa-caret-down"></i></a></th>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php if($vo['level'] == 1): ?>银牌<?php elseif($vo['level'] == 2): ?>金牌<?php elseif($vo['level'] == 3): ?>钻石<?php else: ?>无<?php endif; ?></td>
                                            <td><?php if($vo['allpay'] == ''): ?>0<?php else: ?><?php echo $vo['allpay']; endif; ?></td>
                                            <td><?php if($vo['balance'] == ''): ?>0<?php else: ?><?php echo $vo['balance']; endif; ?></td>
                                            <td><?php echo $vo['upidsum']; ?></td>
                                            <td><?php echo $vo['memsum']; ?></td>
                                            <td><?php if($vo['status'] == 0): ?>关闭<?php else: ?>开启<?php endif; ?></td>
                                            <td><a href="<?php echo url('edit',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm">编辑</a><a href="#" class="btn btn-warning btn-sm">充值</a><a href="<?php echo url('detail',array('id'=>$vo['id'])); ?>" class="btn btn-default btn-sm">浏览</a></td>
                                        </tr>
