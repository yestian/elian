<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\www\tp\elian\public/../application/admin\view\temp\addlogo.html";i:1505923256;s:65:"D:\www\tp\elian\public/../application/admin\view\public\meta.html";i:1504623373;s:63:"D:\www\tp\elian\public/../application/admin\view\temp\menu.html";i:1505885536;}*/ ?>
<!doctype html>
<html lang="en">
                                    ...
                                    <form action="" method='post' enctype="multipart/form-data" class="addagent">
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" name="tempname" datatype="*" placeholder="文本格式">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>logo链接</td>
