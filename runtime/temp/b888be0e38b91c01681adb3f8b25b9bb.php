<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"D:\www\tp\elian\public/../application/member\view\conf\add.html";i:1504623373;s:66:"D:\www\tp\elian\public/../application/member\view\public\meta.html";i:1505446123;s:64:"D:\www\tp\elian\public/../application/member\view\conf\menu.html";i:1505451341;}*/ ?>
<!doctype html>
<html lang="en">
...
<div class="page-summary">
  ...
  <div class="layui-progress-bar layui-bg-orange" lay-percent="<?php echo $menu['agent_mem_per']; ?>%"></div>
                ...
                <div class="page-content">
                    <div class="bread">
                        <i class="icon-home"></i>
                        <a href="#" class="homelink">首页</a> > 添加配置后台
                    </div>
                    <div class="body">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h2 class="panel-title">添加配置后台</h2>
                            </div>
                            <div class="panel-body">
                                <form class="form-horizontal" role="form" action="" method="post">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input class="form-control" placeholder="" name="cnname" type="text" required=''>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input class="form-control" placeholder="" name="enname" type="text" required=''>
                                        </div>
                                        <p class="help-block col-sm-4 red">* 必填</p>
                                    </div>
                                    <div class="form-group">
