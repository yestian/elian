<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\www\tp\elian\public/../application/member\view\auth_rulem\edit.html";i:1505460847;s:66:"D:\www\tp\elian\public/../application/member\view\public\meta.html";i:1505446123;s:72:"D:\www\tp\elian\public/../application/member\view\member_admin\menu.html";i:1505459690;}*/ ?>
<!doctype html>
<html lang="en">
...
<div class="page-summary">
  ...
  <div class="layui-progress-bar layui-bg-orange" lay-percent="<?php echo $menu['agent_mem_per']; ?>%"></div>
                ...
                <div class="page-content">
                    <div class="bread">
                        <i class="icon-home"></i>
                        <a href="#" class="homelink">首页</a> > 编辑权限
                    </div>
                    <div class="body">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h2 class="panel-title">编辑权限 <a href="<?php echo url('add'); ?>" class="btn btn-info btn-xs">添加</a></h2>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select name="pid" class="form-control">
                                                ...
                                                <option <?php if($authRules['pid'] == $authRule['id']): ?> selected="selected" <?php endif; if($authRules['id'] == $authRule['id']): ?> disabled <?php endif; ?> value="<?php echo $authRule['id']; ?>">
