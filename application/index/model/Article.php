...
class Article  extends Model
{
    ...
    public function getNewArticle(){
        $newArtiecleRes=db('article')->field('a.id,a.title,a.desc,a.thumb,a.click,a.zan,a.time,c.catename')->alias('a')->join('cate c','a.cateid=c.id')->order('a.id desc')->limit(10)->select();
